...
const Resume: React.FC = () => {
  ...
  // TypeScript workaround: cast options as any
  const handlePrint = useReactToPrint({
    content: () => resumeRef.current,
    documentTitle: 'Sulaimon_Ekundayo_Resume',
  } as any);
  ...
  return (
    <div className="w-full space-y-8 px-4 sm:px-8 py-8 mt-16 bg-gray-900 text-white">
      ...
      <div className="max-w-4xl mx-auto">
        <button
          onClick={handlePrint}
          className="mb-4 px-6 py-2 bg-blue-600 text-white font-semibold rounded hover:bg-blue-700 transition-colors"
        >
          Download
        </button>
      </div>
      ...
      <div ref={resumeRef} className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-800 shadow-lg rounded-lg p-6">
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-gray-300">
            ...
            <li>
              Previous project experience with Druid Oy, contributing to real-world software development in
              ...
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back bg-gray-600 p-6 rounded-lg overflow-y-auto">
                  <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-gray-300">
                    ...
                    <li>
                      Developed a dynamic React + Vite frontend that improved content delivery by fetching and
                      displaying data efficiently via API
                    </li>
                    <li>
                    ...
                    <li>
                      Accelerated team onboarding and development by providing crucial support in configuring local
                      Strapi environments.
                    </li>
                  </ul>
                </div>
            ...
            <div className="flip-card h-96">
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back bg-gray-600 p-6 rounded-lg overflow-y-auto">
                  <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-gray-300">
                    <li>
                      Successfully integrated Drupal with a React frontend by installing and configuring a Drupal
                      instance with essential modules like JSONAPI.
                    </li>
                    <li>
              ...
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back bg-gray-600 p-6 rounded-lg overflow-y-auto">
                  <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-gray-300">
                    ...
                    <li>
                      Ensured stable software releases by conducting thorough regression, system, and integration
                      testing.
                    </li>
                    <li>
                      Contributed to significant improvements in QA processes and team capabilities by mentoring junior
                      QA members.
                    </li>
                  </ul>
                </div>
              ...
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back bg-gray-600 p-6 rounded-lg overflow-y-auto">
                  <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-gray-300">
                    ...
                    <li>
                      Facilitated quicker resolution of issues by supporting developers in verifying reported problems
                      and participating in regression testing after code changes.
                    </li>
                    <li>
